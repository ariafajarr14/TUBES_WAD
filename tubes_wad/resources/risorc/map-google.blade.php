...
<header class="topbar" data-navbarbg="skin5">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Google map</h4>
                    </div>
                                    ...
                                    <div class="gm-style"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                Map Data</div>
                                            <div style="font-size: 13px;">Map data ©2020 Google, INEGI</div><button
                                            ...
                                            <div draggable="false" class="gm-style-cc"
                                                ...
                                                <div
                                                    ...
                                                    <a style="text-decoration: none; cursor: pointer; display: none;">Map
                                                        Data</a><span>Map data ©2020 Google, INEGI</span></div>
                                            </div>
                                        </div>
    ...
    <!-- google maps api -->
    <script src="/userpage/http://maps.google.com/maps/api/js?sensor=true"></script>
    <script src="/userpage/plugins/bower_components/gmaps/gmaps.min.js"></script>
    <script src="/userpage/plugins/bower_components/gmaps/jquery.gmaps.js"></script>
    <!--Custom JavaScript -->
