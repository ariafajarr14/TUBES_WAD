            ...
            <nav>
                ...
                <div class="menu">
                    <ul>
                        ...
                        <li>
                            @else
                            <a href="{{ route('login') }}" class="text-sm text-gray-700 underline"><button type="button" class="btn"
                                    style="color:white; background-color: #65CFBB; margin-left:100px;">Login</button></a>
                        </li>
                        <li>
                            @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline"><button type="button" class="btn"
                    ...
                    <div class="carousel-inner" style="border-radius: 25px; color:aqua;">
                        ...
                        <div class="carousel-item" data-bs-interval="3000">
                            ...
                            <div class="carousel-caption d-none d-md-block">
                                ...
                                <p>Resep Obat kami diberikan pasti aman dan terjangkau sehingga dapat dijangkau oleh
                                    semua
                                    kalangan. </p>
                            </div>
                        </div>
